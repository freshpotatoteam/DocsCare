...
import com.ddd.docscare.repository.file.FileLocalDataSource
...
import com.ddd.docscare.ui.result.FileViewModel
...
val dataSourcePart = module {
    ...
    single { FileLocalDataSource((get<DocsDatabase>().fileItemDAO())) }
